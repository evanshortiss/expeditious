...
ExpeditiousEngine.prototype.get = function (key, val, expire, callback) {
  callback(
...
ExpeditiousEngine.prototype.set = function (key, callback) {
  callback(
...
ExpeditiousEngine.prototype.flush = function (callback) {
  callback(
...
ExpeditiousEngine.prototype.keys = function (wildcard, callback) {
  callback(
